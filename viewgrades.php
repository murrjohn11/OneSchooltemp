...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
    <header class="app-header navbar">
        <button class="navbar-toggler mobile-sidebar-toggler hidden-lg-up" type="button">Hamburger☰</button><!-- 
                            ...
                            <div class="card-block">
                                    ...
                                    <nav>
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item active">
                                                <a class="page-link" href="viewgrades.php">1</a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="viewgrades1.php">2</a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="viewgrades2.php">3</a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="viewgrades1.php">Next</a>
                                            </li>
                                        </ul>
                                    </nav>
                    </div>
